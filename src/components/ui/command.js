...
function CommandDialog({ title = "Command Palette", description = "Search for a command to run...", children, ...props }) {
    return (_jsxs(Dialog, { ...props, children: [" ", _jsxs(DialogHeader, { className: "sr-only", children: [" ", _jsx(DialogTitle, { children: title }), " ", _jsx(DialogDescription, { children: description }), " "] }), " ", _jsxs(DialogContent, { className: "overflow-hidden p-0", children: [" ", _jsxs(Command, { className: "[&_[cmdk-group-heading]]:text-muted-foreground **:data-[slot=command-input-wrapper]:h-12 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group]]:px-2 [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0 [&_[cmdk-input-wrapper]_svg]:h-5 [&_[cmdk-input-wrapper]_svg]:w-5 [&_[cmdk-input]]:h-12 [&_[cmdk-item]]:px-2 [&_[cmdk-item]]:py-3 [&_[cmdk-item]_svg]:h-5 [&_[cmdk-item]_svg]:w-5", children: [" ", children, " "] }), " "] }), " "] }));
}
