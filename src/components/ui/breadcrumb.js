...
function BreadcrumbSeparator({ children, className, ...props }) {
    return (_jsxs("li", { "data-slot": "breadcrumb-separator", role: "presentation", "aria-hidden": "true", className: cn("[&>svg]:size-3.5", className), ...props, children: [" ", children ?? _jsx(ChevronRight, {}), " "] }));
}
